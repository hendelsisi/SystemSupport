...
namespace BizSparkSupport.MVC.Areas.Admin.Controllers
{
    ...
    public class CategoryAdminController : Controller
    {
        ...
        public ActionResult GetAssignedList()
        {
            ...
            return View("CategoryAdminCasesList", GetEmpCaseList(false));
        }
        ...
        public ActionResult GetOpenList()
        {
            ...
            return View("CategoryAdminCasesList", GetEmpCaseList(true));
        }
        ...
        public ActionResult GetEscalatedList()
        {
            ...
            List<Case> escList = caseRepository.GetBy(c => c.StatusID == 3 && c.CategoryID == currentEmp.CategoryID).ToList();
            return View("CategoryAdminCasesList", escList);
        }
