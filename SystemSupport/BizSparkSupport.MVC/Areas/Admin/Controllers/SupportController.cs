...
namespace BizSparkSupport.MVC.Areas.Admin.Controllers
{
    ...
    public class SupportController : Controller
    {
        ...
        public ActionResult GetNewList()
        {
            ...
            List<Case> newList = caseRepository.GetBy(c => c.CategoryID == currentEmp.CategoryID && c.StatusID == 4).ToList();
            return View("CasesList", newList);
        }
        ...
        public ActionResult GetOpenList()
        {
            ...
            return View("CasesList", GetEmpCaseList(true));
        }
